    ...
    sitemap: Ember.computed('i18n.locale', function () {
      ...
      return {
        nodes: [{
          ...
          link: null,
          caption: i18n.t('forms.application.sitemap.mu6.caption'),
          title: i18n.t('forms.application.sitemap.mu6.title'),
          children: [{
            link: 'i-i-s-mu6-k4-l',
            caption: i18n.t('forms.application.sitemap.mu6.i-i-s-mu6-k4-l.caption'),
            title: i18n.t('forms.application.sitemap.mu6.i-i-s-mu6-k4-l.title'),
            children: null
          }]
        }]
      };
...
define('ember-app/controllers/i-i-s-mu6-k4-e', ['exports', 'ember-flexberry/controllers/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    parentRoute: 'i-i-s-mu6-k4-l'
  });
});
define('ember-app/controllers/i-i-s-mu6-k4-e/new', ['exports', 'ember-app/controllers/i-i-s-mu6-k4-e'], function (exports, _iISMu6K4E) {
  'use strict';
  ...
  var IISmu6K4ENewController = _iISMu6K4E.default;
  exports.default = IISmu6K4ENewController;
});
define('ember-app/controllers/i-i-s-mu6-k4-l', ['exports', 'ember-flexberry/controllers/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @type String
      @default 'i-i-s-mu6-k4-e'
     */
    editFormRoute: 'i-i-s-mu6-k4-e'
  });
});
...
define('ember-app/locales/en/forms/i-i-s-mu6-k4-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/forms/i-i-s-mu6-k4-l', ['exports'], function (exports) {
  'use strict';
...
define("ember-app/locales/en/models/i-i-s-mu6-k4", ["exports"], function (exports) {
  "use strict";
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/forms/i-i-s-mu6-k4-l', 'ember-app/locales/en/forms/i-i-s-mu6-k4-e', 'ember-app/locales/en/models/i-i-s-mu6-k4'], function (exports, _translations, _iISMu6K4L, _iISMu6K4E, _iISMu6K) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    ...
    forms: {
      ...
      'i-i-s-mu6-k4-l': _iISMu6K4L.default,
      'i-i-s-mu6-k4-e': _iISMu6K4E.default
    }
...
define('ember-app/locales/ru/forms/i-i-s-mu6-k4-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/forms/i-i-s-mu6-k4-l', ['exports'], function (exports) {
  'use strict';
...
define("ember-app/locales/ru/models/i-i-s-mu6-k4", ["exports"], function (exports) {
  "use strict";
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/forms/i-i-s-mu6-k4-l', 'ember-app/locales/ru/forms/i-i-s-mu6-k4-e', 'ember-app/locales/ru/models/i-i-s-mu6-k4'], function (exports, _translations, _iISMu6K4L, _iISMu6K4E, _iISMu6K) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-mu6-k4', ['exports', 'ember-flexberry-data/utils/attributes'], function (exports, _attributes) {
  'use strict';
  ...
  let defineProjections = exports.defineProjections = function (modelClass) {
    modelClass.defineProjection('K4E', 'i-i-s-mu6-k4', {});

    modelClass.defineProjection('K4L', 'i-i-s-mu6-k4', {});
  };
});
define('ember-app/mixins/regenerated/serializers/i-i-s-mu6-k4-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-mu6-k4', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/i-i-s-mu6-k4', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/i-i-s-mu6-k4'], function (exports, _emberCpValidations, _model, _offlineModel, _iISMu6K) {
  'use strict';
  ...
  const Validations = (0, _emberCpValidations.buildValidations)(_iISMu6K.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  let Model = _model.default.extend(_offlineModel.default, _iISMu6K.Model, Validations, {});

  (0, _iISMu6K.defineProjections)(Model);
...
define('ember-app/router', ['exports', 'ember-app/config/environment'], function (exports, _environment) {
  ...
  Router.map(function () {
    ...
    this.route('i-i-s-mu6-k4-e', { path: 'i-i-s-mu6-k4-e/:id' });
    this.route('i-i-s-mu6-k4-e.new', { path: 'i-i-s-mu6-k4-e/new' });
  });
...
define('ember-app/routes/i-i-s-mu6-k4-e', ['exports', 'ember-flexberry/routes/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    modelProjection: 'K4E',
    modelName: 'i-i-s-mu6-k4'
  });
});
define('ember-app/routes/i-i-s-mu6-k4-e/new', ['exports', 'ember-flexberry/routes/edit-form-new'], function (exports, _editFormNew) {
  'use strict';
  ...
  exports.default = _editFormNew.default.extend({
    modelProjection: 'K4E',
    modelName: 'i-i-s-mu6-k4',
    templateName: 'i-i-s-mu6-k4-e'
  });
});
define('ember-app/routes/i-i-s-mu6-k4-l', ['exports', 'ember-flexberry/routes/list-form'], function (exports, _listForm) {
  'use strict';
...
define('ember-app/serializers/i-i-s-mu6-k4-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-mu6-k4-offline', 'ember-app/serializers/application-offline'], function (exports, _iISMu6K4Offline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISMu6K4Offline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-mu6-k4', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-mu6-k4', 'ember-app/serializers/application'], function (exports, _iISMu6K, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISMu6K.Serializer, {
    /**
